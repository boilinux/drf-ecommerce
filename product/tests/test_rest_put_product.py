...
class UpdateProductTestCase(TestCase):
    ...
    def test_update_product_not_login(self):
        self.response = self.client.put('/api/v1/product',
                                        {'product_id': self.productOjb.id, 'Store': self.storeObj['id'], 'title': 'Product A', 'description': 'description of product A', 'price': '99.99', 'image': '/file/product_a.jpg'})
        self.response = views.ProductViews.as_view()(self.response)
    ...
    def test_missing_store_id(self):
        self.response = self.client.put('/api/v1/product',
                                        {'product_id': self.productOjb.id, 'title': 'Product A', 'description': 'description of product A', 'price': '99.99', 'image': '/file/product_a.jpg'})
        force_authenticate(self.response, user=self.user1Obj,
                           token=self.userToken)
        self.response = views.ProductViews.as_view()(self.response)
    ...
    def test_missing_title(self):
        self.response = self.client.put('/api/v1/product',
                                        {'product_id': self.productOjb.id, 'Store': self.storeObj['id'], 'description': 'description of product A', 'price': '99.99', 'image': '/file/product_a.jpg'})
        force_authenticate(self.response, user=self.user1Obj,
                           token=self.userToken)
        self.response = views.ProductViews.as_view()(self.response)
    ...
    def test_missing_description(self):
        self.response = self.client.put('/api/v1/product',
                                        {'product_id': self.productOjb.id, 'Store': self.storeObj['id'], 'title': 'Product A', 'price': '99.99', 'image': '/file/product_a.jpg'})
        force_authenticate(self.response, user=self.user1Obj,
                           token=self.userToken)
        self.response = views.ProductViews.as_view()(self.response)
    ...
    def test_missing_price(self):
        self.response = self.client.put('/api/v1/product',
                                        {'product_id': self.productOjb.id, 'Store': self.storeObj['id'], 'title': 'Product A', 'description': 'description of product A', 'image': '/file/product_a.jpg'})
        force_authenticate(self.response, user=self.user1Obj,
                           token=self.userToken)
        self.response = views.ProductViews.as_view()(self.response)
    ...
    def test_missing_image(self):
        self.response = self.client.put('/api/v1/product',
                                        {'product_id': self.productOjb.id, 'Store': self.storeObj['id'], 'title': 'Product A', 'description': 'description of product A', 'price': '99.99'})
        force_authenticate(self.response, user=self.user1Obj,
                           token=self.userToken)
        self.response = views.ProductViews.as_view()(self.response)
    ...
    def test_update_product_title(self):
        self.response = self.client.put('/api/v1/product',
                                        {'product_id': self.productOjb.id, 'Store': self.storeObj['id'], 'title': '123123123123123 Product B', 'description': 'description of product A', 'price': '99.99', 'image': '/file/product_a.jpg'})
        force_authenticate(self.response, user=self.user1Obj,
                           token=self.userToken)
        self.response = views.ProductViews.as_view()(self.response)
        ...
        self.updatedProduct = models.Product.objects.get(pk=self.productOjb.id)
        self.assertEqual(self.updatedProduct.title,
                         '123123123123123 Product B')

    def test_update_product_description(self):
        self.response = self.client.put('/api/v1/product',
                                        {'product_id': self.productOjb.id, 'Store': self.storeObj['id'], 'title': 'Product A', 'description': 'new description of product A', 'price': '99.99', 'image': '/file/product_a.jpg'})
        force_authenticate(self.response, user=self.user1Obj,
                           token=self.userToken)
        self.response = views.ProductViews.as_view()(self.response)
        ...
        self.updatedProduct = models.Product.objects.get(pk=self.productOjb.id)
        self.assertEqual(self.updatedProduct.description,
                         'new description of product A')

    def test_update_product_price(self):
        self.response = self.client.put('/api/v1/product',
                                        {'product_id': self.productOjb.id, 'Store': self.storeObj['id'], 'title': 'Product A', 'description': 'description of product A', 'price': '100', 'image': '/file/product_a.jpg'})
        force_authenticate(self.response, user=self.user1Obj,
                           token=self.userToken)
        self.response = views.ProductViews.as_view()(self.response)
        ...
        self.updatedProduct = models.Product.objects.get(pk=self.productOjb.id)
        self.assertEqual(self.updatedProduct.price,
                         '100')

    def test_update_product_image(self):
        self.response = self.client.put('/api/v1/product',
                                        {'product_id': self.productOjb.id, 'Store': self.storeObj['id'], 'title': 'Product A', 'description': 'description of product A', 'price': '99.99', 'image': '/file/new_product_a.jpg'})
        force_authenticate(self.response, user=self.user1Obj,
                           token=self.userToken)
        self.response = views.ProductViews.as_view()(self.response)
        ...
        self.updatedProduct = models.Product.objects.get(pk=self.productOjb.id)
        self.assertEqual(self.updatedProduct.image,
                         '/file/new_product_a.jpg')
